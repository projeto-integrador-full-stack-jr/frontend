...
const buttonVariants = {
    primary: 'bg-[#2C49FA] hover:bg-[#102FF9] text-white px-5 py-2 rounded-md ',
    ...
    danger: 'bg-[#EA4335] hover:bg-[#CB2415] text-white font-medium px-5 py-3 rounded-md w-full',
    tertiary: 'bg-white text-[#2C49FA] hover:bg-[#2C49FA] hover:text-white font-medium px-5 py-3 rounded-md w-full',
};
