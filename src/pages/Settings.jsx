...
const Settings = () => {
    ...
    return (
        <LayoutPage>
            <div className="mt-20 flex min-h-full w-full items-center justify-center">
                <div className="flex w-full max-w-md flex-col justify-start">
                    <h3 className="text-xl font-extrabold text-[#3F3D56] lg:self-auto lg:text-3xl">Configurações</h3>
                        ...
                        <div className="mt-10 flex items-center justify-start gap-4">
                            ...
                            <Modal>
                                <button
                                    ...
                                    type="button"
                                    className="flex cursor-pointer items-center justify-center !font-semibold text-red-500 hover:text-red-700"
                                >
                                    Deletar conta
                                </button>
                            </Modal>
